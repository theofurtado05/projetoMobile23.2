package com.example.telainicial.Fragments
...
class NavBar : Fragment() {
    ...
    override fun onCreateView(
        ...
        val btHoje = view.findViewById<Button>(R.id.btHoje)
        val btVisualizacao = view.findViewById<Button>(R.id.btVisualizacao)
        val btAdicionar = view.findViewById<Button>(R.id.btAdd)
        val btBuscar = view.findViewById<Button>(R.id.btBuscar)
        val btConfiguracoes = view.findViewById<Button>(R.id.btConfig)
